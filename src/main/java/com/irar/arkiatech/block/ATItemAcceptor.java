...
public class ATItemAcceptor extends ATContainerBlockBase<TileItemAcceptor> implements IItemPipe, ICustomBoundingBox{
	...
	private boolean canPipeConnectTo(IBlockAccess world, BlockPos pos, EnumFacing facing) {
		...
		return block instanceof IItemPipe || te instanceof IInventory;
	}
