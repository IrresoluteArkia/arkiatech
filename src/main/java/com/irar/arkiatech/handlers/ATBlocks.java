...
//	public static Block itemAcceptor;
	...
	public static void init() {
		...
		grinder = new ATGrinder(Material.ROCK, "grinder").setHardness(1.0F).setResistance(10.0F);
		generator = new ATGenerator(Material.ROCK, "generator").setHardness(1.0F).setResistance(10.0F);
		upgrader = new ATUpgrader(Material.ROCK, "upgrader").setHardness(1.0F).setResistance(10.0F);
		pFurnace = new ATPFurnace(Material.ROCK, "p_furnace").setHardness(1.0F).setResistance(10.0F);
		charger = new ATCharger(Material.ROCK, "charger").setHardness(1.0F).setResistance(10.0F);
		energyPipe = new ATEnergyPipe(Material.ROCK, "energy_pipe").setHardness(1.0F).setResistance(3.0F);
		machineFrame = new ATBlockBase(Material.ROCK, "machine_frame").setHardness(1.0F).setResistance(3.0F);
		reMachineFrame = new ATBlockBase(Material.ROCK, "machine_frame_reinforced").setHardness(3.0F).setResistance(10.0F);
		zephyrBlock = new ATBlockBase(Material.ROCK, "zephyr_block").setRenderSeeThrough(true).setHardness(1.0F).setResistance(3.0F);
		upIronBlock = new ATBlockBase(Material.ROCK, "up_iron_block").setHardness(1.0F).setResistance(3.0F);
		upGoldBlock = new ATBlockBase(Material.ROCK, "up_gold_block").setHardness(1.0F).setResistance(3.0F);
		upQuartzBlock = new ATBlockBase(Material.ROCK, "up_quartz_block").setHardness(1.0F).setResistance(3.0F);
		upDiamondBlock = new ATBlockBase(Material.ROCK, "up_diamond_block").setHardness(1.0F).setResistance(3.0F);
		upEmeraldBlock = new ATBlockBase(Material.ROCK, "up_emerald_block").setHardness(1.0F).setResistance(3.0F);
		coZephyrBlock = new ATBlockBase(Material.ROCK, "co_zephyr_block").setRenderSeeThrough(true).setHardness(3.0F).setResistance(10.0F);
		itemPipe = new ATItemAcceptor(Material.ROCK, "item_pipe").setHardness(1.0F).setResistance(3.0F);
		itemSource = new ATItemSource(Material.ROCK, "item_source").setHardness(1.0F).setResistance(3.0F);
